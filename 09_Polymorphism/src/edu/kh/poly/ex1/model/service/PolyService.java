...
//자식타입 참조변수 = 자식객체주소
	...
	// Tesla, Spark와 같은 자식객체의 고유 필드, 메소드 사용 불가
	...
	System.out.println(arr[1] instanceof Spark);  //false(자기 본인 맞음)
	...
	public void ex3() {
		...
		// Tesla 객체의 getBatteryCapacity()를 사용할 수 있게 된다.
	...
	public void ex5() {
		//바인딩 (Binding)
		//실제 실행한 메소드 코드와 호출하는 코드를 연결시키는 것.
		
		Car c1 = new Car("경유엔진" , "경유" , 8);  //다형성 적용 x
		
		System.out.println( c1.toString() );
		// edu.kh.poly.ex1.model.dto.Car.toString ()
		// Car 객체에 있는 toString() 메소드를 호출
		// 프로그램 "실행 전"
