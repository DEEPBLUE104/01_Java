...
public class LARCalculator implements Calculator, TestInterface {
	...
	// The type LARCalculator must implement the inherited 
	// abstract method Calculator.minus(int, int)
