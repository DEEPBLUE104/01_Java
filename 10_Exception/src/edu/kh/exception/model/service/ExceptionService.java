...
public class ExceptionService {
	...
	try { 
		...
		// try에서 던져진 예외를 catch의 매개변수 e로 잡았다.
		// e를 사용하여 추적 코드 작성할 수도 있음
		System.out.println("infinity");
		e.printStackTrace();	
	...
	try {
		...
		// InputMismatchException, ArithmeticException 둘다 Runtime Exception 후손
	...
	}	// FileNotFoundException > 	IOException > Exception 상속관계라 괜찮음
