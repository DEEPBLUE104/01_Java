...
public class MemberService {
	...
	public MemberService() { //기본 생성자 생성
	...
	public int emptyIndex() {
		...
		// 참조하는 값이 null 인 경우에 인덱스를 반환
		for(int i = 0; i < memberArr.length; i++) {
			
			if(memberArr[i] == null) {
				return i;
				//현재 메서드 종료하고 호출한 곳으로 i값 가지고 돌아감
			}
		}
