...
public class MemberService {
	...
	private Member memberInfo = null;  //가입한 회원의 정보를 전엽적으로 저장해줄 변수
	...
	public String login() {
		...
		if(memberInfo == null) { //회원가입 x
			//null : 아무것도 참조하고 있지 않음
			return "회원가입부터 진행해주세요!";
			//return 값;
			// -> 현재 메서드를 종료하고 값을 가지고 해당 메서드를 호출한 쪽으로
			//되돌아감
	...
	//-> 조회하려면?
	//-> 로그인을 했는지 안 했는지 확인
	//1. 로그인 했으면? 현재 로그인한 사람의 정보를 
	//저장하고 있는 객체에서 정보 얻어오기 (이름, 아이디, 나이)
